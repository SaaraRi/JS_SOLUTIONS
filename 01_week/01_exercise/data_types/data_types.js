...
/* let age = 50;
let fullName = 'Hanna Smith';
let isStudent = true;
const hobbies = ['coding', 'cooking'];
const education = { schoolName: 'Business College Helsinki', grade: 10 };
...
const hobbies = ['running', 'reading', 'cleaning'];
const info = {
...
// console.log (' dollarsign ) template literal shows all on dif lines
