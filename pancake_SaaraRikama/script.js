...
function displayOrder() {
    const customerName = document.querySelector('input[id="customerName"]').value;
    ...
    orderCustomerName.textContent = customerName.charAt(0).toUpperCase() + customerName.slice(1);
